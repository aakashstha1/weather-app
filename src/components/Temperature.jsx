  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center text-slate-200 mt-8">
        ...
        <span className="text-[33px] text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
          °C
        </span>
      </div>
      ...
      <div className="flex justify-center text-slate-400 mt-5 text-[15px]">
        Today - {stats.time} | {stats.location}, {stats.country}
      </div>
    </>
  );
}
